...
public class MayorkImpl extends ComplexInstructionImpl implements Mayork
{
  ...
  public NotificationChain basicSetVal(edu.upb.lp.rebotinol.Number newVal, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, RebotinolPackage.MAYORK__VAL, oldVal, newVal);
  ...
  public void setVal(edu.upb.lp.rebotinol.Number newVal)
  {
    if (newVal != val)
    {
      ...
      if (val != null)
        msgs = ((InternalEObject)val).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - RebotinolPackage.MAYORK__VAL, null, msgs);
      if (newVal != null)
        msgs = ((InternalEObject)newVal).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - RebotinolPackage.MAYORK__VAL, null, msgs);
      msgs = basicSetVal(newVal, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RebotinolPackage.MAYORK__VAL, newVal, newVal));
  }
