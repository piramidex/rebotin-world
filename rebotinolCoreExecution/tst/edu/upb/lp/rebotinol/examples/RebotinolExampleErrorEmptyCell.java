 ...
 * The program generates an empty cell error while trying to sum all fours numbers.
 * 
 * @author Alfredo Villalba
 * 
 */
public class RebotinolExampleErrorEmptyCell extends RebotinolExample {
	...
	protected void buildExpectedResult() {
		_expectedResult = new Fraction(8);
	}
}
